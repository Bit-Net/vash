...
contains(USE_SQLITE, 1) {
    DEFINES += SQLITE_THREADSAFE=1 USE_SQLITE
}
...
FORMS += \
    ...
    src/qt/forms/zkpdialog.ui \
    src/qt/forms/optionsdialog.ui

HEADERS += src/qt/forms/mainframe.h
SOURCES += src/qt/forms/mainframe.cpp

HEADERS += src/qt/zkpdialog.h
SOURCES += src/qt/zkpdialog.cpp
