...
public:
    ...
    */
    ...
    int64_t GetMinFee(unsigned int nBlockSize=1, enum GetMinFee_mode mode=GMF_BLOCK, unsigned int nBytes = 0, bool bZkpMintTx=false) const;
    ...
    bool CheckTransaction(bool bZkpMintTx, bool bChkMiniValue = true) const;
