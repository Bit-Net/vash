...
class MultisigInputEntry : public QFrame
{
  ...
  private:
    ...
    WalletModel *model;
    uint256 txHash;
    QString curTransactionId;

    void onTransactionIdChanged(const QString &transactionId);
  private slots:
    void on_transactionIdComb_textChanged(const QString &transactionId);
    ...
    void on_listUnSpentTransactionsButton_clicked();
};
