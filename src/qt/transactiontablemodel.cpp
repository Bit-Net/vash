...
QString TransactionTableModel::formatTxType(const TransactionRecord *wtx) const
{
    ...
    case TransactionRecord::Generated:
        return tr("Mined");
    case TransactionRecord::MintCoin:
        return tr("Minted");
    case TransactionRecord::BurnCoin:
        return tr("Burned");
    default:
        return QString();
    }
...
QVariant TransactionTableModel::txStatusDecoration(const TransactionRecord *wtx) const
{
    ...
    case TransactionStatus::Confirming:
        ...
        case 6: return QIcon(":/icons/transaction_6");
        case 7: return QIcon(":/icons/transaction_7");
        case 8: return QIcon(":/icons/transaction_8");
        case 9: return QIcon(":/icons/transaction_9");
        default: return QIcon(":/icons/transaction_9");
        };
    case TransactionStatus::Confirmed:
...
QString TransactionTableModel::formatTooltip(const TransactionRecord *rec) const
{
    ...
    if(rec->type==TransactionRecord::RecvFromOther || rec->type==TransactionRecord::SendToOther ||
       rec->type==TransactionRecord::BurnCoin || rec->type==TransactionRecord::MintCoin || 
