...
protected:
    ...
    bool Write(const K& key, const T& value)
    {
        ...
        ssValue << value;
        if( dw_zip_txdb > 0 ) bitnet_pack_Db_DataStream( ssValue );
...
public:
    ...
    bool AddZeroKnowledgeProof(const CZeroKnowledgeProof& zkp);
    bool ReadZeroKnowledgeProof(uint256 hash, CZeroKnowledgeProof& zkp);
    bool UpdateZeroKnowledgeProof(uint256 hash, const CZeroKnowledgeProof& zkp);
    bool EraseZeroKnowledgeProof(const CZeroKnowledgeProof& zkp);
    bool ContainsZeroKnowledgeProof(uint256 hash);

    bool AddCZeroKnowledgeProofMintKey(const CZeroKnowledgeProofMintKey& zmk);
    bool ReadCZeroKnowledgeProofMintKey(uint256 hash, CZeroKnowledgeProofMintKey& zmk);
    bool UpdateCZeroKnowledgeProofMintKey(uint256 hash, const CZeroKnowledgeProofMintKey& zmk);
    bool EraseCZeroKnowledgeProofMintKey(const CZeroKnowledgeProofMintKey& zmk);
    bool ContainsCZeroKnowledgeProofMintKey(uint256 hash);

    bool AddCZeroKnowledgeProofMintTx(const CTransaction& tx);
    bool ReadCZeroKnowledgeProofMintTx(uint256 hash, int& v);
    bool EraseCZeroKnowledgeProofMintTx(const CTransaction& tx);
    bool ContainsCZeroKnowledgeProofMintTx(const CTransaction& tx);
