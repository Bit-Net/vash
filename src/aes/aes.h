...
public:
...
#endif
    int FileCipher(const string sFile, string& sRzt);
    int FileInvCipher(const string sFile, string& sRzt);
    ...
    int Cipher(const string input, string& sRzt);
    int InvCipher(const string input, string& sRzt);
};
